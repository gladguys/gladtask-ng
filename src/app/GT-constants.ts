...
export class GTConstants {
  //Upload Related
  static readonly GLADTASK_UPLOAD_PATH: string =
    environment.API + '/file/upload';
  ...
  static readonly BASE_FILE_PATH: string =
    'https://s3.amazonaws.com' + '/' + GTConstants.AWS_BUCKET;
}
